import Zoo1 from '../../assets/zoo_employee_1_profile.png'
import Zoo2 from '../../assets/zoo_employee_2_profile.png'
import Zoo3 from '../../assets/zoo_employee_3_profile.png'
import Zoo4 from '../../assets/zoo_employee_4_profile.png'
import Zoo5 from '../../assets/zoo_employee_5_profile.png'
import Zoo6 from '../../assets/zoo_employee_6_profile.png'
import Zoo7 from '../../assets/zoo_employee_7_profile.png'
import Zoo8 from '../../assets/zoo_employee_8_profile.png'
    ...
    <div className='container max-w-7xl mx-auto px-4 py-32'>
      <div className='text-center mb-12'>
        ...
        <p className='text-xl text-gray-600'>
          혁신과 성장을 이끄는 DalGom Company의 리더쉽
        </p>
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-12 mb-24 items-center'>
        <div className='md:w-2/3'>
          ...
          <div className='text-lg text-gray-600 space-y-6'>
            <p>안녕하십니까, DalGom Company 대표이사 김대표입니다.</p>
            <p>
              저희 DalGom Company는 20년 이상의 전기 산업 경력을 바탕으로,
            ...
            <p className='font-semibold mt-8'>
              DalGom Company 대표이사 김대표 드림
            </p>
          </div>
        </div>
        <div className='md:w-1/3'>
          <div className='rounded-xl overflow-hidden shadow-lg'>
            <img src={Zoo1} className='w-full aspect-[3/4] object-cover' />
